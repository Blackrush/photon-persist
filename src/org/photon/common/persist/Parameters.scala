...
object Parameters {
  implicit object ByteParameter extends Parameter[Byte] {
    ...
    def set(ps: PreparedStatement, index: Index, value: Byte) = ps.setByte(index(), value)
  }
  ...
  implicit object ShortParameter extends Parameter[Short] {
    ...
    def set(ps: PreparedStatement, index: Index, value: Short) = ps.setShort(index(), value)
  }
  ...
  implicit object IntParameter extends Parameter[Int] {
    ...
    def set(ps: PreparedStatement, index: Index, value: Int) = ps.setInt(index(), value)
  }
  ...
  implicit object LongParameter extends Parameter[Long] {
    ...
    def set(ps: PreparedStatement, index: Index, value: Long) = ps.setLong(index(), value)
  }
  ...
  implicit object StringParameter extends Parameter[String] {
    ...
    def set(ps: PreparedStatement, index: Index, value: String) = ps.setString(index(), value)
  }
  ...
  implicit object TimeParameter extends Parameter[Time] {
    ...
    def set(ps: PreparedStatement, index: Index, value: Time) = ps.setTimestamp(index(), new Timestamp(value.inMilliseconds))
  }
  ...
  implicit object FloatParameter extends Parameter[Float] {
    ...
    def set(ps: PreparedStatement, index: Index, value: Float) = ps.setFloat(index(), value)
  }
  ...
  implicit object DoubleParameter extends Parameter[Double] {
    ...
    def set(ps: PreparedStatement, index: Index, value: Double) = ps.setDouble(index(), value)
  }
  ...
  implicit object BooleanParameter extends Parameter[Boolean] {
    ...
    def set(ps: PreparedStatement, index: Index, value: Boolean) = ps.setBoolean(index(), value)
  }
  ...
  implicit def OptionParameter[T](implicit p: Parameter[T], ev: Null <:< T) = new Parameter[Option[T]] {
    ...
    def set(ps: PreparedStatement, index: Index, value: Option[T]) = p.set(ps, index, value.orNull)
  }
  ...
  implicit def DurationParameter(implicit timeUnit: TimeUnit = MILLISECONDS) = new Parameter[Duration] {
    ...
    def set(ps: PreparedStatement, index: Index, value: Duration) = ps.setLong(index(), value.inUnit(timeUnit))
  }
